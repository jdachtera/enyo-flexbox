enyo.kind({
    ...
    statics: {
        ...
        _getSize: function(control, orientation) {
            return control.hasNode() ?
                    control.node[orientation === 'vertical' ? 'offsetHeight' : 'offsetWidth'] : 0;
        },
        _getPadding: function(control, orientation) {
            return this._getStyle(control, orientation === 'vertical' ? 'padding-top' : 'padding-right') + 
                    this._getStyle(control, orientation === 'vertical' ? 'padding-bottom' : 'padding-left');
        },
        _getMargin: function(control, orientation) {
            return this._getStyle(control, orientation === 'vertical' ? 'margin-top' : 'margin-right') + 
                    this._getStyle(control, orientation === 'vertical' ? 'margin-bottom' : 'margin-left');
        },
        _detect: function() {
    ...
    _emulateAlign: function() {
        ...
        if (this.align === 'stretch') {
            enyo.forEach(this.container.children, function(child) {
                child.applyStyle(
                    this.oppositeOrientation === 'vertical' ? 'height' : 'width', 
                    (alignSize  - this.ctor._getMargin(child, this.oppositeOrientation))+ 'px'
                );
            }, this);
        } else if (this.align === 'center') {
            enyo.forEach(this.container.children, function(child) {
                child.applyStyle(
                    this.orientation === 'vertical' ? 'margin-left' : 'margin-top', 
                    (alignSize - this.ctor._getSize(child, this.oppositeOrientation)) / 2 + 'px'
                );
            }, this);
            ...
            enyo.forEach(this.container.children, function(child) {
                child.applyStyle(
                    this.orientation === 'vertical' ? 'margin-left' : 'margin-top', 
                    (alignSize - this.ctor._getSize(child, this.oppositeOrientation)) + 'px'
                );
            }, this);
        }
    },
        ...
        if (this.flexCount === 0 && this.container.children.length) { 
            if (this.pack === 'center') {
                ...
                enyo.forEach(this.container.children.slice(1), function(child) {
                    child.applyStyle(
                        this.orientation === 'horizontal' ? 'margin-left' : 'margin-top',
                        (this.available  / (this.container.children.length - 1))  + 'px'
                    );
                }, this);
            }
        }
